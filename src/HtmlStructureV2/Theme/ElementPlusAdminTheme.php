...
final class ElementPlusAdminTheme implements ThemeInterface
{
    ...
    .sc-v2-table-settings-modal{position:fixed;inset:0;z-index:2000;display:flex;align-items:flex-start;justify-content:center;padding:4vh 16px 16px;background:rgba(15,23,42,.38)}
    .dialog-fade-enter-active .sc-v2-table-settings-modal__panel{animation:dialog-fade-in var(--el-transition-duration)}
    .dialog-fade-leave-active .sc-v2-table-settings-modal__panel{animation:dialog-fade-out var(--el-transition-duration)}
    .sc-v2-table-settings-modal__panel{max-height:92vh;display:flex;flex-direction:column;background:#fff;border-radius:14px;box-shadow:0 20px 60px rgba(15,23,42,.24);overflow:hidden}
    .sc-v2-table-settings-modal__panel--normal{width:min(96vw,760px)}
    ...
    .sc-v2-table-settings-list__row:last-child{border-bottom:none}
    .sc-v2-table-settings-list__cell{display:flex;align-items:center;justify-content:center;min-width:0}
    .sc-v2-table-settings-list__cell--name{justify-content:flex-start;font-size:13px;font-weight:400;line-height:1.3;color:var(--el-text-color-primary)}
    .sc-v2-table-settings-list__cell--name span{display:block;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
    .sc-v2-table-settings-list__cell--sort{padding-left:4px;padding-right:4px}
    .sc-v2-table-settings-list__body .el-input,.sc-v2-table-settings-list__body .el-select{width:100%}
