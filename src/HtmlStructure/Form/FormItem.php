 ...
 * @method static FormItemTag tag(string $name = null, ?string $label = null)
 ...
 * @method static FormItemGroup group(FormItemInterface|string ...$children) 如果是字符串时则只识别两个参数为 label, name
